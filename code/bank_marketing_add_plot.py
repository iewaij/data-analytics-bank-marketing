...
class_names = ['no', 'yes']
plt.figure()
plot_confusion_matrix(cmtr_gs1, classes=class_names)
#### Plot confusion matrix for test-prediction
np.set_printoptions(precision=2)
class_names = ['no', 'yes']
plt.figure()
plot_confusion_matrix(cmte_gs1, classes=class_names)
...
class_names = ['no', 'yes']
plt.figure()
plot_confusion_matrix(cmtr_gs2, classes=class_names)
#### Plot confusion matrix for test-prediction
np.set_printoptions(precision=2)
class_names = ['no', 'yes']
plt.figure()
plot_confusion_matrix(cmte_gs2, classes=class_names)
